...
class Standard extends Micuentaweb
{
    ...
    protected function getTokenDataForOrder($order)
    {
        ...
        // Currency.
        $currency = \Lyranetwork\Micuentaweb\Model\Api\Form\Api::findCurrencyByAlphaCode($order->getQuoteCurrencyCode());
        if (! $currency) {
            // If currency is not supported, use base currency.
            $currency = \Lyranetwork\Micuentaweb\Model\Api\Form\Api::findCurrencyByAlphaCode($order->getBaseCurrencyCode());
